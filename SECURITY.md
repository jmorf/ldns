...
Report privately via [GitHub Security Advisories](https://github.com/jmorf/ldns/security/advisories/new), or contact [@jmorf on X](https://x.com/jmorf). I aim to acknowledge within 72 hours.
...
Out of scope: vulnerabilities in the upstream services LDNS queries (Cloudflare DoH, Google DNS, DNS.SB, rdap.org, crt.sh, hstspreload.org, Team Cymru), and findings that require a compromised local machine or browser.
